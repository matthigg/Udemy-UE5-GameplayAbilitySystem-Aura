...
// This is a generic template function pointer that can return a pointer to any type of function
template<class T>
...
public:
	...
	// This maps GameplayTags to function pointers
	...
	// Meta Attributes (not replicated - set on the server and then affect replicated attributes)
	UPROPERTY(BlueprintReadOnly, Category = "Meta Attributes")
	FGameplayAttributeData IncomingDamage;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, IncomingDamage);

	/**
	 * Rep Notifies provide the old attribute value (e.g. OldStrength) by default
	 */
